...
sudo -i -u $deadlineuser_name $installer_path --deadline-version "$deadline_version" --skip-download-installers --skip-certgen-during-install --post-certgen --skip-certgen-during-rcs-install
